...
export const SITE_CONFIG = {
  name: "Marzuki | Frontend Developer & Fullstack Developer",
  domain: typeof window !== "undefined" ? window.location.hostname : "uki.my.id",
  url:
    typeof window !== "undefined" ? window.location.origin : "https://uki.my.id",
  description:
    "Marzuki (Ukay) - Experienced Frontend Developer & Fullstack Engineer from Indonesia with 4+ years of expertise in React.js, Next.js, TypeScript, Tailwind CSS, Node.js, and web application architecture.",
  author: "Marzuki",
  themeColor: "#1a73e8",
};
