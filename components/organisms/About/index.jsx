          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2 text-xs text-[#202124]">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[11px] text-[#4d5156] truncate">https://uki.my.id &rsaquo; about &rsaquo; marzuki</span>
              </div>
            </div>
            ...
            <div className="p-4 space-y-4 text-xs text-[#3c4043]">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="https://uki.my.id" className="text-[#1a0dab] hover:underline">
                    uki.my.id
                  </a>
                </div>
              </div>
